 ...
 * @return {object} (ipAddresses) - An object containing the IPv4 address called `ipv4` and the IPv6 address called `ipv6`.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  if (!cidr.isValid()) {
    ...
    const firstIpAddress = cidr.toArray(options)[0];
    ipAddresses = {ipv4: firstIpAddress, ipv6: getIpv4MappedIpv6Address(firstIpAddress)};
  }
